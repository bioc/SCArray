...
(http://www.bioconductor.org/packages/SingleCellExperiment)
...
logcnt  # DelayedMatrix

cM <- DelayedMatrixStats::colMeans2(logcnt)
str(cM)
rM <- DelayedMatrixStats::rowMeans2(logcnt)
str(rM)
```
